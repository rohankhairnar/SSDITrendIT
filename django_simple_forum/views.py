...
def index(request):
    ...
    return render(request,"django_simple_forum/list.html", {'forums': forums,
                                'user': request.user})
...
def forum(request, forum_id):
    ...
    return render("django_simple_forum/forum.html", add_csrf(request, topics=topics, pk=forum_id, forum=forum),
                           )
...
def post_reply(request, topic_id):
    ...
    return render(request, 'django_simple_forum/reply.html',{'form': form, 'topic': topic}, context)
